...
var Comment = /** @class */ (function () {
    function Comment(id, description, type) {
        this.id = id;
        this.description = description;
        this.type = type;
        this.date = Comment.genDate();
    }
    Comment.genDate = function () {
...
var CommentsService = /** @class */ (function () {
    ...
    CommentsService.prototype.getComments = function () {
        return _db__WEBPACK_IMPORTED_MODULE_2__["Db"].sort(function (a, b) {
    ...
    CommentsService.prototype.addComment = function (description, type) {
        var id = Object(_db__WEBPACK_IMPORTED_MODULE_2__["genId"])();
    ...
    CommentsService.prototype.editComment = function (comment) {
        _db__WEBPACK_IMPORTED_MODULE_2__["Db"].forEach(function (comm) {
    ...
    CommentsService.prototype.deleteComment = function (id) {
        var indToDel = _db__WEBPACK_IMPORTED_MODULE_2__["Db"].findIndex(function (comment) {
            return comment.id === id;
        });
...
var CommentSingleComponent = /** @class */ (function () {
    function CommentSingleComponent(router, route, CommentsService) {
        this.router = router;
        this.route = route;
        this.CommentsService = CommentsService;
    }
    CommentSingleComponent.prototype.ngOnInit = function () {
        this.id = +this.route.snapshot.paramMap.get('id');
        this.getComment();
    };
    CommentSingleComponent.prototype.getComment = function () {
        this.comment = this.CommentsService.getComment(this.id);
    };
    CommentSingleComponent.prototype.deleteComment = function () {
        this.CommentsService.deleteComment(this.id);
        // this.router.navigateByUrl('/comments');
        this.router.navigate(['/comments', { queryParams: { delete: 'success' } }]);
    };
    CommentSingleComponent.prototype.editComment = function (type, description) {
        // this.CommentsService.editComment(this.comment);
        this.CommentsService.editComment({ id: this.comment.id, type: type, description: description });
        this.router.navigate(['/comments', { queryParams: { edit: 'success' } }]);
    };
    CommentSingleComponent.prototype.showDialog = function (name) {
        switch (name) {
            case 'delete':
    ...
    CommentSingleComponent.prototype.hideDialog = function (name) {
        switch (name) {
            case 'delete':
    ...
    CommentSingleComponent.ctorParameters = function () { return [
        { type: _angular_router__WEBPACK_IMPORTED_MODULE_2__["Router"] },
...
var CommentsComponent = /** @class */ (function () {
    ...
    CommentsComponent.prototype.getComments = function () {
        this.comments = this.CommentsService.getComments().sort(function (a, b) {
            return b.date - a.date;
        });
    };
    CommentsComponent.prototype.addComment = function (description, type) {
